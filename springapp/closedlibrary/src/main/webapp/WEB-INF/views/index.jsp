...
<html lang="en" dir="ltr">
  ...
  <body>
    <header class="wrapper">
      <div>
        <h1><a href="index.html">Closed Library</a></h1>
        <!--<img src="images/book_864685.png" alt="Opened book icon" width="32px" height="32px"/>-->
        <!--<img src="images/closed_638535.png" alt="Closed sign icon" width="32px" height="32px"/>-->
      </div>
      <ul>
